  ...
  methods: {
    Burger() {
      ...
      function Remove() {
        ...
        BurgerLine3.classList.remove('NavBar-HamburgerLine3_Exit');
      ...
      // eslint-disable-next-line
      function Open() {
        BurgerLine1.classList.add('NavBar-HamburgerLine1_Exit');
        BurgerLine2.classList.add('NavBar-HamburgerLine2_Exit');
